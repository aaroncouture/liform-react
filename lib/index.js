...
exports.compileSchema = exports.buildSyncValidation = exports.setError = exports.DefaultTheme = exports.processSubmitErrors = exports.renderField = exports.renderFields = undefined;
...
var Liform = function Liform(props) {
  ...
  var formName = props.formKey || props.schema.title || "formhahahah";
  var validator = props.syncValidation || (0, _buildSyncValidation2.default)(schema, props.ajv);
...
exports.buildSyncValidation = _buildSyncValidation2.default;
exports.compileSchema = _compileSchema2.default;